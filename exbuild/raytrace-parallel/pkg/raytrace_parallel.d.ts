...
declare interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke1_mut__h6664878e079969fd: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h7cfca8a50f89be4d: (a: number, b: number, c: number) => void;

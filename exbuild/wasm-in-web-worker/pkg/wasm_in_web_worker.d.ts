...
declare interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke1_mut__h577a7b2428287b9c: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h5cc5dbde1d90868a: (a: number, b: number) => void;
